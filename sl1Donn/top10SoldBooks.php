  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="box">  
              <i class="material-icons" style="font-size:10px;color: white">question_answer</i>
              <br>
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <section>
         ...
         $sqlSoldBooks = "SELECT * FROM SoldBooksCount ORDER BY count DESC LIMIT 0,10;";
         $resultSoldBooks = $conn->query($sqlSoldBooks);
         ...
         <div class="bookshelf">
          ...
          <section class="bookshelf">
            <?php
            if ($resultSoldBooks->num_rows > 0) {
                          // output data of each row
              while($rowSoldBook = $resultSoldBooks->fetch_assoc()) {
