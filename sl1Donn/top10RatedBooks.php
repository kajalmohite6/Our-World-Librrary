    ...
    <div class="row">
      <div class="col-md-3">
        <nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="width:250px" id="mySidebar">
          ...
          <div class="col-md-3">
                          <br>
              <h3>Details of Top 10 Rated Books</h3>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <section>
           ...
           $sqltop10RatedBook = "SELECT * FROM Books ORDER BY CAST(Rating as DECIMAL(10,5)) DESC LIMIT 10";
           $resulttop10RatedBook = $conn->query($sqltop10RatedBook);

           ?>
           <div class="bookshelf">

            <?php
            if ($resulttop10RatedBook->num_rows > 0) {
                          // output data of each row
              while($rowtop10RatedBook = $resulttop10RatedBook->fetch_assoc()) {

                $BId=$rowtop10RatedBook['BId'];
