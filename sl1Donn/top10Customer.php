    ...
    <div class="row">
      <div class="col-md-3">
        <nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="width:250px" id="mySidebar">
          ...
          <div class="col-md-3">
            <br>
            <h3>Details of Top 10 Customer</h3>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <section>
           ...
           $sqltop10Customer = "SELECT * FROM top10Customer ORDER BY count DESC limit 10";
           
           $resulttop10Customer = $conn->query($sqltop10Customer);
           ?>
           <div class="bookshelf">
             
            <section class="bookshelf">
              <?php
              if ($resulttop10Customer->num_rows > 0) {
                          // output data of each row
                while($rowtop10Customer = $resulttop10Customer->fetch_assoc()) {

                  $User_Id=$rowtop10Customer['User_Id'];

                  $sql = "SELECT * FROM Customer,top10Customer WHERE Customer.User_Id = $User_Id AND top10Customer.User_Id = $User_Id";
                // UNION
                // ("SELECT * FROM top10Customer WHERE User_Id = $User_Id");
