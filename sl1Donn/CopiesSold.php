      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <section>
           ...
           $sqlCopiesSold = "SELECT * FROM Purchase_and_Deliver ORDER BY Delivery_date";
           $resultCopiesSold = $conn->query($sqlCopiesSold);
           ...
           <div class="bookshelf">
            ...
            <?php
            if ($resultCopiesSold->num_rows > 0) {
                          // output data of each row
              while($rowCopiesSold = $resultCopiesSold->fetch_assoc()) {

                $BId=$rowCopiesSold['BId'];
                $User_Id=$rowCopiesSold['User_Id'];
                $PDId=$rowCopiesSold['PDId'];

                $sql = "SELECT * FROM Books,Customer,Purchase_and_Deliver WHERE Books.BId = $BId
                AND Customer.User_Id = $User_Id AND Purchase_and_Deliver.PDId = $PDId";
