    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <section>
         ...
         $sqlDetailofCustomer = "SELECT * FROM Customer ORDER BY First_Name";
         
         $resultDetailofCustomer = $conn->query($sqlDetailofCustomer);
         ?>
         <div class="bookshelf">
         
          <section class="bookshelf">
            <?php
            if ($resultDetailofCustomer->num_rows > 0) {
                          // output data of each row
              while($rowDetailofCustomer = $resultDetailofCustomer->fetch_assoc()) {

                $User_Id=$rowDetailofCustomer['User_Id'];
