            ...
            <ul class="price">
              ...
              <li class="header">
                ...
                if ($conn->query($sqlInsert) === TRUE && $row_quantity['Quantity']>0) {
                  ...
                  // </div>
                  echo "Book Purchased";
                  $link_address = 'checkout1.php';
                 //echo '<a href="checkout1.php">Enter shipping details</a>';  
                 // echo "<a href='".$checkout1.php."'>Link</a>"; 
                  echo "<a href='".$link_address."'>Enter shipping details</a>";          
